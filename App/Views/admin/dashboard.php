...
<body>
    ...
    <div style="margin-bottom:20px;">
        <a href="/public/index.php?route=home">Ir al inicio</a> |
        <a href="/public/index.php?route=logout">Cerrar sesión</a>
    </div>

    <hr>

    <h2>Registrar Cine</h2>
    <form action="/public/index.php?route=guardar-cine" method="POST">
    ...
    <form action="/public/index.php?route=guardar-sala" method="POST">
        <input type="number" name="numero" placeholder="Número" required>
        <input type="text" name="tipo" placeholder="Tipo (2D, 3D, IMAX)">
    ...
    <form action="/public/index.php?route=guardar-pelicula" method="POST">
        <input type="text" name="titulo" placeholder="Título" required>
        <input type="number" name="duracion" placeholder="Duración en minutos">
        <textarea name="descripcion" placeholder="Descripción"></textarea>
        <input type="date" name="fecha_estreno">
        <input type="text" name="estado" placeholder="Estado (cartelera, próximo estreno)">
        <button type="submit">Guardar Película</button>
    </form>

    <h2>Registrar Género</h2>
    <form action="/public/index.php?route=guardar-genero" method="POST">
    ...
    <form action="/public/index.php?route=guardar-funcion" method="POST">
    ...
    <form action="/public/index.php?route=guardar-asiento" method="POST">
        <input type="text" name="fila" placeholder="Fila (A, B, C...)" required>
